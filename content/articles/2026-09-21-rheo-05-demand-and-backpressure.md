...
description: "An unbounded fetch is not enthusiasm. It is a redelivery storm waiting for a crash."
date: 2026-09-21
tags:
  - Rheo
  - Elixir
...
This is part 5 of [Rheo](https://thanos.github.io/series/rheo/). An unbounded fetch is not enthusiasm. It is a redelivery storm waiting for a crash.

The first version of every database consumer looks like this:
...
`max_demand` is how many unsettled leases the Group will hold. `concurrency` is how many handler tasks may run at once. They are not the same number, and treating them as one knob is how you starve workers or drown the database.
