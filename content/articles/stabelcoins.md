...
- **Pre-2014 precursors**: As noted, the ECU (1979–1998) served EU institutions as a stable accounting and payment tool and was replaced by the euro at 1:1 parity on January 1, 1999. The IMF’s SDRs, launched in 1969, provided a parallel global reserve asset based on a currency basket.

- **2014: The first stablecoins**: Tether (USDT) launched as the first major fiat-backed stablecoin. Around the same time, BitUSD appeared on the BitShares blockchain as an early crypto-collateralized example.

- **2017**: MakerDAO introduced DAI (later rebranded under the Sky protocol as USDS), the first prominent decentralized stablecoin. It relied on over-collateralization with other cryptocurrencies rather than bank-held reserves.

- **2018**: Circle and Coinbase launched USD Coin (USDC), emphasizing regulatory compliance and transparency through regular attestations of reserves.

- **2022: A major lesson in risk**: The algorithmic stablecoin TerraUSD (UST) collapsed dramatically in May 2022. The event triggered a “death spiral” in the broader Terra ecosystem (including LUNA), wiping out approximately $45–50 billion in combined market value within days. This collapse highlighted the dangers of designs that lacked sufficient collateral or robust mechanisms to maintain stability and served as a cautionary tale for the entire industry.[^2]

- **2023–2025: Maturation and regulation**: The 2023 failure of Silicon Valley Bank briefly caused USDC to depeg before recovering quickly. Regulatory frameworks advanced globally, including the European Union’s MiCA regulation and the U.S. GENIUS Act passed in 2025, which provided clearer rules for stablecoin issuers. Major traditional players entered the space: PayPal launched PYUSD, and banks and payment networks began integrating stablecoins. Yield-bearing synthetic stablecoins, such as Ethena’s USDe, gained traction by offering returns while maintaining the peg through hedging strategies.
...
- **Individuals**: Traders use them to park funds between volatile trades. People in high-inflation economies treat them as a digital savings tool or hedge against local currency depreciation. Remittance senders benefit from low-cost, instant transfers to family abroad.

- **Businesses and institutions**: Companies hold stablecoins for treasury management, enabling faster global settlements than traditional wire transfers. Payment processors and fintech firms integrate them for B2B payments. Hedge funds and asset managers use them for liquidity.

- **DeFi participants**: Developers and users interact with lending protocols, decentralized exchanges, and yield-generating strategies where stablecoins provide the primary liquidity.

- **Governments and regulators**: While not issuers of stablecoins themselves (distinct from central bank digital currencies, or CBDCs), many monitor and regulate them. Some jurisdictions explore tokenized bank deposits that function similarly.
...
Usage spans:
- **Decentralized finance platforms**: Liquidity pools and lending markets.
- **Centralized exchanges**: As the base pair for trading (for example, BTC/USDT).
- **Real-world payments**: Merchant acceptance, remittances, and corporate treasury operations.
- **Emerging markets**: High adoption in regions with currency instability or limited banking access.
...
- Tether (USDT): ~$184 billion market cap – largest, highest liquidity, widely available.
- USD Coin (USDC): ~$78 billion – favored by institutions for transparency and compliance.
- Sky Dollar (USDS): ~$11.5 billion – leading decentralized option.
- Ethena USDe: ~$5.8 billion – popular yield-bearing synthetic.
- PayPal USD (PYUSD): ~$4 billion – growing rapidly through mainstream payment integration.
...
- Issuance toolkits such as Circle’s APIs or open-source Stablecoin Studio.
- Oracle providers like Chainlink for price data.
- Smart-contract frameworks such as Hardhat or thirdweb.
...
**Additional Sources**:
- ECU and SDR historical context: Official EU and IMF records.
- Stablecoin market shares and mechanics: Aggregated from DeFiLlama, CoinGecko, and issuer attestations (April 2025).
- Forward Rate Agreements (FRAs): Standard financial derivatives definition.